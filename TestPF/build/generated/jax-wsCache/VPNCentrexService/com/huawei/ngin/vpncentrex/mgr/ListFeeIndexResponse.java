 ...
 *         &lt;element name="feeIndexs" type="{http://www.huawei.com/ngin/vpncentrex/domain}FeeIndex1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listFeeIndexResponse")
public class ListFeeIndexResponse {
    ...
    protected List<FeeIndex1> feeIndexs;
    ...
    /**
     * Gets the value of the feeIndexs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the feeIndexs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFeeIndexs().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<FeeIndex1> getFeeIndexs() {
        if (feeIndexs == null) {
            feeIndexs = new ArrayList<FeeIndex1>();
        }
        return this.feeIndexs;
    }
