 ...
 *         &lt;element name="attendantTime" type="{http://www.huawei.com/ngin/vpncentrex/domain}AttendantTime1"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "displayAttendantWorkTimeResponse")
public class DisplayAttendantWorkTimeResponse {
    ...
    @XmlElement(required = true, nillable = true)
    protected AttendantTime1 attendantTime;
    ...
    /**
     * Obtiene el valor de la propiedad attendantTime.
     * 
     * @return
     *     possible object is
     *     {@link AttendantTime1 }
     *     
     */
    public AttendantTime1 getAttendantTime() {
        return attendantTime;
    }

    /**
     * Define el valor de la propiedad attendantTime.
     * 
     * @param value
     *     allowed object is
     *     {@link AttendantTime1 }
     *     
     */
    public void setAttendantTime(AttendantTime1 value) {
        this.attendantTime = value;
    }
