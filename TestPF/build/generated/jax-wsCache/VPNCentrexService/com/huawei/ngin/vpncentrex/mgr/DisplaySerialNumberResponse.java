 ...
 *         &lt;element name="serialProvision" type="{http://www.huawei.com/ngin/vpncentrex/domain}SerialProvision1"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "displaySerialNumberResponse")
public class DisplaySerialNumberResponse {
    ...
    @XmlElement(required = true, nillable = true)
    protected SerialProvision1 serialProvision;
     ...
     *     
     */
    public SerialProvision1 getSerialProvision() {
     ...
     *     
     */
    public void setSerialProvision(SerialProvision1 value) {
