 ...
 *         &lt;element name="callingBind" type="{http://www.huawei.com/ngin/vpncentrex/domain}CallingBind" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "createCallingBind")
public class CreateCallingBind {
    ...
    protected JAXBElement<CallingBind> callingBind;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CallingBind }{@code >}
     *     
     */
    public JAXBElement<CallingBind> getCallingBind() {
        return callingBind;
    }
     ...
     *     
     */
    public void setCallingBind(JAXBElement<CallingBind> value) {
