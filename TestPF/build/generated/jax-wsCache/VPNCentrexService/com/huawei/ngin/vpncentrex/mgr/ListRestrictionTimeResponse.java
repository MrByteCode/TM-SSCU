 ...
 *         &lt;element name="restrictionTimes" type="{http://www.huawei.com/ngin/vpncentrex/domain}RestrictionTime2" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listRestrictionTimeResponse")
public class ListRestrictionTimeResponse {
    ...
    protected List<RestrictionTime2> restrictionTimes;
    ...
    /**
     * Gets the value of the restrictionTimes property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the restrictionTimes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRestrictionTimes().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RestrictionTime2 }
     * 
     * 
     */
    public List<RestrictionTime2> getRestrictionTimes() {
        if (restrictionTimes == null) {
            restrictionTimes = new ArrayList<RestrictionTime2>();
        }
