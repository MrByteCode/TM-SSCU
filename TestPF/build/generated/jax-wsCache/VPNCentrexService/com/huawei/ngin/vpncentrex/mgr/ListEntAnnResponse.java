 ...
 *         &lt;element name="entAnns" type="{http://www.huawei.com/ngin/vpncentrex/domain}EntAnn3" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listEntAnnResponse")
public class ListEntAnnResponse {
    ...
    protected List<EntAnn3> entAnns;
    ...
    /**
     * Gets the value of the entAnns property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the entAnns property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEntAnns().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<EntAnn3> getEntAnns() {
        if (entAnns == null) {
            entAnns = new ArrayList<EntAnn3>();
        }
        return this.entAnns;
    }
