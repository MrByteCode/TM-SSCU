 ...
 *         &lt;element name="callingBinds" type="{http://www.huawei.com/ngin/vpncentrex/domain}CallingBind" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listCallingBindResponse")
public class ListCallingBindResponse {
    ...
    protected List<CallingBind> callingBinds;
    ...
    /**
     * Gets the value of the callingBinds property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the callingBinds property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCallingBinds().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CallingBind> getCallingBinds() {
        if (callingBinds == null) {
            callingBinds = new ArrayList<CallingBind>();
        }
        return this.callingBinds;
    }
