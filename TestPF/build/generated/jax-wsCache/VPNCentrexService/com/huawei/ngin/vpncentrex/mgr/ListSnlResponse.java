 ...
 *         &lt;element name="snlInfoLists" type="{http://www.huawei.com/ngin/vpncentrex/domain}SNLInfoList" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listSnlResponse")
public class ListSnlResponse {
    ...
    protected List<SNLInfoList> snlInfoLists;
    ...
    /**
     * Gets the value of the snlInfoLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the snlInfoLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSnlInfoLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SNLInfoList> getSnlInfoLists() {
        if (snlInfoLists == null) {
            snlInfoLists = new ArrayList<SNLInfoList>();
        }
        return this.snlInfoLists;
    }
