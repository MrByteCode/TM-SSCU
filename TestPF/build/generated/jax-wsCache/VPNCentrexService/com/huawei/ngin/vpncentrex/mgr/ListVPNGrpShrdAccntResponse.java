 ...
 *         &lt;element name="VPNGrpShrdAccnt" type="{http://www.huawei.com/ngin/vpncentrex/domain}VPNGrpShrdAccnt" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listVPNGrpShrdAccntResponse")
public class ListVPNGrpShrdAccntResponse {
    ...
    @XmlElement(name = "VPNGrpShrdAccnt", nillable = true)
    protected List<VPNGrpShrdAccnt> vpnGrpShrdAccnt;
    ...
    /**
     * Gets the value of the vpnGrpShrdAccnt property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the vpnGrpShrdAccnt property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVPNGrpShrdAccnt().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link VPNGrpShrdAccnt }
     * 
     * 
     */
    public List<VPNGrpShrdAccnt> getVPNGrpShrdAccnt() {
        if (vpnGrpShrdAccnt == null) {
            vpnGrpShrdAccnt = new ArrayList<VPNGrpShrdAccnt>();
        }
        return this.vpnGrpShrdAccnt;
    }
