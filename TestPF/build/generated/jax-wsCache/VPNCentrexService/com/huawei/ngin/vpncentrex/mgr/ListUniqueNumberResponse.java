 ...
 *         &lt;element name="uniqueNumberInfo" type="{http://www.huawei.com/ngin/vpncentrex/domain}UniqueNumber1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listUniqueNumberResponse")
public class ListUniqueNumberResponse {
    ...
    protected List<UniqueNumber1> uniqueNumberInfo;
    ...
    /**
     * Gets the value of the uniqueNumberInfo property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the uniqueNumberInfo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUniqueNumberInfo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<UniqueNumber1> getUniqueNumberInfo() {
        if (uniqueNumberInfo == null) {
            uniqueNumberInfo = new ArrayList<UniqueNumber1>();
        }
        return this.uniqueNumberInfo;
    }
