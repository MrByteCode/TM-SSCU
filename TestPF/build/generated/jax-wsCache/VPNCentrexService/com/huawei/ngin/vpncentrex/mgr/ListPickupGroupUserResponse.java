 ...
 *         &lt;element name="pickupGroupUsers" type="{http://www.huawei.com/ngin/vpncentrex/domain}PickUpGroupUser3" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlRootElement(name = "listPickupGroupUserResponse")
public class ListPickupGroupUserResponse {
    ...
    protected List<PickUpGroupUser3> pickupGroupUsers;
    ...
    /**
     * Gets the value of the pickupGroupUsers property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pickupGroupUsers property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPickupGroupUsers().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PickUpGroupUser3 }
     * 
     * 
     */
    public List<PickUpGroupUser3> getPickupGroupUsers() {
        if (pickupGroupUsers == null) {
            pickupGroupUsers = new ArrayList<PickUpGroupUser3>();
        }
        return this.pickupGroupUsers;
    }
