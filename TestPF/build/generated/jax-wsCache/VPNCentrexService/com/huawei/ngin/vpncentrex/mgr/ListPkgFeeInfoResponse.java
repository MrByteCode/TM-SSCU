 ...
 *         &lt;element name="pkgFeeIndexs" type="{http://www.huawei.com/ngin/vpncentrex/domain}PkgFeeIndex1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listPkgFeeInfoResponse")
public class ListPkgFeeInfoResponse {
    ...
    protected List<PkgFeeIndex1> pkgFeeIndexs;
    ...
    /**
     * Gets the value of the pkgFeeIndexs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pkgFeeIndexs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPkgFeeIndexs().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PkgFeeIndex1> getPkgFeeIndexs() {
        if (pkgFeeIndexs == null) {
            pkgFeeIndexs = new ArrayList<PkgFeeIndex1>();
        }
        return this.pkgFeeIndexs;
    }
