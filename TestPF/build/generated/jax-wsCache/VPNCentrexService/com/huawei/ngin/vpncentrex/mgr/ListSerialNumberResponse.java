 ...
 *         &lt;element name="serialProvisions" type="{http://www.huawei.com/ngin/vpncentrex/domain}SerialProvision1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listSerialNumberResponse")
public class ListSerialNumberResponse {
    ...
    protected List<SerialProvision1> serialProvisions;
    ...
    /**
     * Gets the value of the serialProvisions property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the serialProvisions property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSerialProvisions().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SerialProvision1 }
     * 
     * 
     */
    public List<SerialProvision1> getSerialProvisions() {
        if (serialProvisions == null) {
            serialProvisions = new ArrayList<SerialProvision1>();
        }
        return this.serialProvisions;
    }
