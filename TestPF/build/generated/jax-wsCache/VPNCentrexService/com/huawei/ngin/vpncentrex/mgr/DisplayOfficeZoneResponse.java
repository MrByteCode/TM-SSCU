 ...
 *         &lt;element name="officeZone" type="{http://www.huawei.com/ngin/vpncentrex/domain}OfficeZone"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "displayOfficeZoneResponse")
public class DisplayOfficeZoneResponse {
    ...
    @XmlElement(required = true, nillable = true)
    protected OfficeZone officeZone;
     ...
     *     
     */
    public OfficeZone getOfficeZone() {
        return officeZone;
    }
     ...
     *     
     */
    public void setOfficeZone(OfficeZone value) {
