 ...
 *         &lt;element name="routingBasedOnCallers" type="{http://www.huawei.com/ngin/vpncentrex/domain}RoutingBasedOnCaller4" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "", propOrder = {
    ...
    "rowsPerPage",
    "totalPageNum",
    "routingBasedOnCallers"
})
@XmlRootElement(name = "listNumberBasedRoutingResponse")
public class ListNumberBasedRoutingResponse {
    ...
    protected List<RoutingBasedOnCaller4> routingBasedOnCallers;
    ...
    /**
     * Gets the value of the routingBasedOnCallers property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the routingBasedOnCallers property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRoutingBasedOnCallers().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RoutingBasedOnCaller4 }
     * 
     * 
     */
    public List<RoutingBasedOnCaller4> getRoutingBasedOnCallers() {
        if (routingBasedOnCallers == null) {
            routingBasedOnCallers = new ArrayList<RoutingBasedOnCaller4>();
        }
        return this.routingBasedOnCallers;
    }
