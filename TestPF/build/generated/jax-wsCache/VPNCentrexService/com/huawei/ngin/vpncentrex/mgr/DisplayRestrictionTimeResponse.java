 ...
 *         &lt;element name="restrictionTime" type="{http://www.huawei.com/ngin/vpncentrex/domain}RestrictionTime2"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "displayRestrictionTimeResponse")
public class DisplayRestrictionTimeResponse {
    ...
    @XmlElement(required = true, nillable = true)
    protected RestrictionTime2 restrictionTime;
     ...
     *     
     */
    public RestrictionTime2 getRestrictionTime() {
     ...
     *     
     */
    public void setRestrictionTime(RestrictionTime2 value) {
