 ...
 *         &lt;element name="enterpriseLicenses" type="{http://www.huawei.com/ngin/vpncentrex/domain}EnterpriseLicense1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listEnterpriseLicenseResponse")
public class ListEnterpriseLicenseResponse {
    ...
    protected List<EnterpriseLicense1> enterpriseLicenses;
    ...
    /**
     * Gets the value of the enterpriseLicenses property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the enterpriseLicenses property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEnterpriseLicenses().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link EnterpriseLicense1 }
     * 
     * 
     */
    public List<EnterpriseLicense1> getEnterpriseLicenses() {
        if (enterpriseLicenses == null) {
            enterpriseLicenses = new ArrayList<EnterpriseLicense1>();
        }
