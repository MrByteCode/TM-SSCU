 ...
 *         &lt;element name="fnFListNumbers" type="{http://www.huawei.com/ngin/vpncentrex/domain}FnFListNumber" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listFnFListNumberResponse")
public class ListFnFListNumberResponse {
    ...
    protected List<FnFListNumber> fnFListNumbers;
    ...
    /**
     * Gets the value of the fnFListNumbers property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fnFListNumbers property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFnFListNumbers().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<FnFListNumber> getFnFListNumbers() {
        if (fnFListNumbers == null) {
            fnFListNumbers = new ArrayList<FnFListNumber>();
        }
        return this.fnFListNumbers;
    }
