 ...
 *         &lt;element name="c2CGroups" type="{http://www.huawei.com/ngin/vpncentrex/domain}C2CGroup2" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listC2CGroupResponse")
public class ListC2CGroupResponse {
    ...
    protected List<C2CGroup2> c2CGroups;
    ...
    /**
     * Gets the value of the c2CGroups property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the c2CGroups property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getC2CGroups().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<C2CGroup2> getC2CGroups() {
        if (c2CGroups == null) {
            c2CGroups = new ArrayList<C2CGroup2>();
        }
        return this.c2CGroups;
    }
