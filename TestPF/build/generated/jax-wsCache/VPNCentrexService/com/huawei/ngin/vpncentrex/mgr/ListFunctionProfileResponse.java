 ...
 *         &lt;element name="functionProfiles" type="{http://www.huawei.com/ngin/vpncentrex/domain}FunctionProfile1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listFunctionProfileResponse")
public class ListFunctionProfileResponse {
    ...
    protected List<FunctionProfile1> functionProfiles;
    ...
    /**
     * Gets the value of the functionProfiles property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the functionProfiles property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFunctionProfiles().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FunctionProfile1 }
     * 
     * 
     */
    public List<FunctionProfile1> getFunctionProfiles() {
        if (functionProfiles == null) {
            functionProfiles = new ArrayList<FunctionProfile1>();
        }
