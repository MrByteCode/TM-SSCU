 ...
 *         &lt;element name="speedNLInfoLists" type="{http://www.huawei.com/ngin/vpncentrex/domain}SpeedNLInfoList" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listSpeedNumberListResponse")
public class ListSpeedNumberListResponse {
    ...
    protected List<SpeedNLInfoList> speedNLInfoLists;
    ...
    /**
     * Gets the value of the speedNLInfoLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the speedNLInfoLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSpeedNLInfoLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SpeedNLInfoList }
     * 
     * 
     */
    public List<SpeedNLInfoList> getSpeedNLInfoLists() {
        if (speedNLInfoLists == null) {
            speedNLInfoLists = new ArrayList<SpeedNLInfoList>();
        }
        return this.speedNLInfoLists;
    }
