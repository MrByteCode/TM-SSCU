 ...
 *         &lt;element name="pbxLinks" type="{http://www.huawei.com/ngin/vpncentrex/domain}PBXLink2" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listPBXLinkResponse")
public class ListPBXLinkResponse {
    ...
    protected List<PBXLink2> pbxLinks;
    ...
    /**
     * Gets the value of the pbxLinks property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pbxLinks property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPbxLinks().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PBXLink2> getPbxLinks() {
        if (pbxLinks == null) {
            pbxLinks = new ArrayList<PBXLink2>();
        }
        return this.pbxLinks;
    }
