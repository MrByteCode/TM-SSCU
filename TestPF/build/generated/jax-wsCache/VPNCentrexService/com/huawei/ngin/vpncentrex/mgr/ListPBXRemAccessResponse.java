 ...
 *         &lt;element name="pbxRemAccesss" type="{http://www.huawei.com/ngin/vpncentrex/domain}PBXRemAccess2" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listPBXRemAccessResponse")
public class ListPBXRemAccessResponse {
    ...
    protected List<PBXRemAccess2> pbxRemAccesss;
    ...
    /**
     * Gets the value of the pbxRemAccesss property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pbxRemAccesss property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPbxRemAccesss().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PBXRemAccess2> getPbxRemAccesss() {
        if (pbxRemAccesss == null) {
            pbxRemAccesss = new ArrayList<PBXRemAccess2>();
        }
        return this.pbxRemAccesss;
    }
