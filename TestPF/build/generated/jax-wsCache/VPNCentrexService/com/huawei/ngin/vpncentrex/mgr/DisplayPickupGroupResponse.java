 ...
 *         &lt;element name="pickupGroups" type="{http://www.huawei.com/ngin/vpncentrex/domain}PickupGroupInfo" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "displayPickupGroupResponse")
public class DisplayPickupGroupResponse {
    ...
    protected List<PickupGroupInfo> pickupGroups;
     ...
     * This is why there is not a <CODE>set</CODE> method for the pickupGroups property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPickupGroups().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PickupGroupInfo }
     * 
     * 
     */
    public List<PickupGroupInfo> getPickupGroups() {
        if (pickupGroups == null) {
            pickupGroups = new ArrayList<PickupGroupInfo>();
        }
