 ...
 *         &lt;element name="cpcInfos" type="{http://www.huawei.com/ngin/vpncentrex/domain}CpcInfo" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listCPCResponse")
public class ListCPCResponse {
    ...
    protected List<CpcInfo> cpcInfos;
    ...
    /**
     * Gets the value of the cpcInfos property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the cpcInfos property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCpcInfos().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CpcInfo> getCpcInfos() {
        if (cpcInfos == null) {
            cpcInfos = new ArrayList<CpcInfo>();
        }
        return this.cpcInfos;
    }
