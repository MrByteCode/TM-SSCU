 ...
 *         &lt;element name="profile" type="{http://www.huawei.com/ngin/vpncentrex/domain}Profile3" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listProfile")
public class ListProfile {
    ...
    protected JAXBElement<Profile3> profile;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Profile3 }{@code >}
     *     
     */
    public JAXBElement<Profile3> getProfile() {
        return profile;
    }
     ...
     *     
     */
    public void setProfile(JAXBElement<Profile3> value) {
        this.profile = value;
    }
