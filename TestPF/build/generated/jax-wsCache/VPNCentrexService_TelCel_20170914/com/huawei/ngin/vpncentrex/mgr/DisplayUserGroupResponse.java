 ...
 *         &lt;element name="userGroup" type="{http://www.huawei.com/ngin/vpncentrex/domain}UserGroup1"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "displayUserGroupResponse")
public class DisplayUserGroupResponse {
    ...
    @XmlElement(required = true, nillable = true)
    protected UserGroup1 userGroup;
     ...
     *     
     */
    public UserGroup1 getUserGroup() {
        return userGroup;
    }
     ...
     *     
     */
    public void setUserGroup(UserGroup1 value) {
