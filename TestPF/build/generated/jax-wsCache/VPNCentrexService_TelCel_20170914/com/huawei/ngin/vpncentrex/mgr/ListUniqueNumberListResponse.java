 ...
 *         &lt;element name="UniqueNumberLists" type="{http://www.huawei.com/ngin/vpncentrex/domain}UniqueNumberList1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listUniqueNumberListResponse")
public class ListUniqueNumberListResponse {
    ...
    @XmlElement(name = "UniqueNumberLists", nillable = true)
    protected List<UniqueNumberList1> uniqueNumberLists;
    ...
    /**
     * Gets the value of the uniqueNumberLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the uniqueNumberLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUniqueNumberLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link UniqueNumberList1 }
     * 
     * 
     */
    public List<UniqueNumberList1> getUniqueNumberLists() {
        if (uniqueNumberLists == null) {
            uniqueNumberLists = new ArrayList<UniqueNumberList1>();
        }
        return this.uniqueNumberLists;
    }
