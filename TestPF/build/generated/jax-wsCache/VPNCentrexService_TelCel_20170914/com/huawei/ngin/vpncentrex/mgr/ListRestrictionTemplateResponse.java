 ...
 *         &lt;element name="restrictionTemplateLists" type="{http://www.huawei.com/ngin/vpncentrex/domain}RestrictionTemplateList" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "", propOrder = {
    ...
    "totalSize",
    "rowsPerPage",
    "restrictionTemplateLists"
})
@XmlRootElement(name = "listRestrictionTemplateResponse")
public class ListRestrictionTemplateResponse {
    ...
    protected List<RestrictionTemplateList> restrictionTemplateLists;
    ...
    /**
     * Gets the value of the restrictionTemplateLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the restrictionTemplateLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRestrictionTemplateLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RestrictionTemplateList }
     * 
     * 
     */
    public List<RestrictionTemplateList> getRestrictionTemplateLists() {
        if (restrictionTemplateLists == null) {
            restrictionTemplateLists = new ArrayList<RestrictionTemplateList>();
        }
        return this.restrictionTemplateLists;
    }
