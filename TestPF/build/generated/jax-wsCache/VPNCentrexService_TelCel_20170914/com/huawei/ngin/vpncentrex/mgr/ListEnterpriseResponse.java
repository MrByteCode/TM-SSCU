 ...
 *         &lt;element name="enterprises" type="{http://www.huawei.com/ngin/vpncentrex/domain}Enterprise2" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listEnterpriseResponse")
public class ListEnterpriseResponse {
    ...
    protected List<Enterprise2> enterprises;
    ...
    /**
     * Gets the value of the enterprises property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the enterprises property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEnterprises().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Enterprise2> getEnterprises() {
        if (enterprises == null) {
            enterprises = new ArrayList<Enterprise2>();
        }
