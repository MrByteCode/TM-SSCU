 ...
 *         &lt;element name="pnpPolicys" type="{http://www.huawei.com/ngin/vpncentrex/domain}PNPPolicy" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listPNPPolicyResponse")
public class ListPNPPolicyResponse {
    ...
    protected List<PNPPolicy> pnpPolicys;
    ...
    /**
     * Gets the value of the pnpPolicys property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pnpPolicys property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPnpPolicys().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PNPPolicy> getPnpPolicys() {
        if (pnpPolicys == null) {
            pnpPolicys = new ArrayList<PNPPolicy>();
        }
        return this.pnpPolicys;
    }
