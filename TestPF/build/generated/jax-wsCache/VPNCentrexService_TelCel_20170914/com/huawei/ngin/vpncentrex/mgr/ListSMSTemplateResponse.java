 ...
 *         &lt;element name="smsTemplates" type="{http://www.huawei.com/ngin/vpncentrex/domain}SMSTemplate" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listSMSTemplateResponse")
public class ListSMSTemplateResponse {
    ...
    protected List<SMSTemplate> smsTemplates;
    ...
    /**
     * Gets the value of the smsTemplates property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the smsTemplates property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSmsTemplates().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<SMSTemplate> getSmsTemplates() {
        if (smsTemplates == null) {
            smsTemplates = new ArrayList<SMSTemplate>();
        }
