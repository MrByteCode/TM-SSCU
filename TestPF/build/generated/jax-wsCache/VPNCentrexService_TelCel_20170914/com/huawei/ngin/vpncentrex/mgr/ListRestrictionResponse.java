 ...
 *         &lt;element name="restrictions" type="{http://www.huawei.com/ngin/vpncentrex/domain}Restriction4" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listRestrictionResponse")
public class ListRestrictionResponse {
    ...
    protected List<Restriction4> restrictions;
     ...
     * 
     */
    public List<Restriction4> getRestrictions() {
        if (restrictions == null) {
            restrictions = new ArrayList<Restriction4>();
        }
