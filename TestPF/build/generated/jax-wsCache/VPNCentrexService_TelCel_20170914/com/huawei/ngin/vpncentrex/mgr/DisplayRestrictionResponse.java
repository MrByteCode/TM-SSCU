 ...
 *         &lt;element name="restriction" type="{http://www.huawei.com/ngin/vpncentrex/domain}Restriction5"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "displayRestrictionResponse")
public class DisplayRestrictionResponse {
    ...
    @XmlElement(required = true, nillable = true)
    protected Restriction5 restriction;
     ...
     *     
     */
    public Restriction5 getRestriction() {
        return restriction;
    }
     ...
     *     
     */
    public void setRestriction(Restriction5 value) {
