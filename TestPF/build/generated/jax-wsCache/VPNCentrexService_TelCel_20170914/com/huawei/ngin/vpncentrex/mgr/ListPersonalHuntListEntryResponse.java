 ...
 *         &lt;element name="huntingListEntrys" type="{http://www.huawei.com/ngin/vpncentrex/domain}HuntingListEntry3" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listPersonalHuntListEntryResponse")
public class ListPersonalHuntListEntryResponse {
    ...
    protected List<HuntingListEntry3> huntingListEntrys;
    ...
    /**
     * Gets the value of the huntingListEntrys property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the huntingListEntrys property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHuntingListEntrys().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link HuntingListEntry3 }
     * 
     * 
     */
    public List<HuntingListEntry3> getHuntingListEntrys() {
        if (huntingListEntrys == null) {
            huntingListEntrys = new ArrayList<HuntingListEntry3>();
        }
        return this.huntingListEntrys;
    }
