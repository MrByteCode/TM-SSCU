 ...
 *         &lt;element name="personalHuntings" type="{http://www.huawei.com/ngin/vpncentrex/domain}PersonalHunting2" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listPersonalHuntingResponse")
public class ListPersonalHuntingResponse {
    ...
    protected List<PersonalHunting2> personalHuntings;
    ...
    /**
     * Gets the value of the personalHuntings property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the personalHuntings property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPersonalHuntings().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PersonalHunting2 }
     * 
     * 
     */
    public List<PersonalHunting2> getPersonalHuntings() {
        if (personalHuntings == null) {
            personalHuntings = new ArrayList<PersonalHunting2>();
        }
        return this.personalHuntings;
    }
