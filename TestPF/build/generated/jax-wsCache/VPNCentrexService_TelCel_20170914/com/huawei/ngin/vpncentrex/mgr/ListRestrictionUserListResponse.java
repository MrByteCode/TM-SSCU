 ...
 *         &lt;element name="restrictionUserLists" type="{http://www.huawei.com/ngin/vpncentrex/domain}RestrictionUserList2" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "", propOrder = {
    ...
    "rowsPerPage",
    "totalPageNum",
    "restrictionUserLists"
})
@XmlRootElement(name = "listRestrictionUserListResponse")
public class ListRestrictionUserListResponse {
    ...
    protected List<RestrictionUserList2> restrictionUserLists;
    ...
    /**
     * Gets the value of the restrictionUserLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the restrictionUserLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRestrictionUserLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RestrictionUserList2 }
     * 
     * 
     */
    public List<RestrictionUserList2> getRestrictionUserLists() {
        if (restrictionUserLists == null) {
            restrictionUserLists = new ArrayList<RestrictionUserList2>();
        }
        return this.restrictionUserLists;
    }
