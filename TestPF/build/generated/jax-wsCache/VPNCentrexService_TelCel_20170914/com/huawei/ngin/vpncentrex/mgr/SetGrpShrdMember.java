 ...
 *         &lt;element name="memberAccountrLmt" type="{http://www.huawei.com/ngin/vpncentrex/domain}MemberAccountrLmt" minOccurs="0"/&gt;
...
public class SetGrpShrdMember {
    ...
    @XmlElementRef(name = "memberAccountrLmt", type = JAXBElement.class, required = false)
    protected JAXBElement<MemberAccountrLmt> memberAccountrLmt;
    ...
    /**
     * Obtiene el valor de la propiedad memberAccountrLmt.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link MemberAccountrLmt }{@code >}
     *     
     */
    public JAXBElement<MemberAccountrLmt> getMemberAccountrLmt() {
        return memberAccountrLmt;
    }

    /**
     * Define el valor de la propiedad memberAccountrLmt.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link MemberAccountrLmt }{@code >}
     *     
     */
    public void setMemberAccountrLmt(JAXBElement<MemberAccountrLmt> value) {
        this.memberAccountrLmt = value;
    }
