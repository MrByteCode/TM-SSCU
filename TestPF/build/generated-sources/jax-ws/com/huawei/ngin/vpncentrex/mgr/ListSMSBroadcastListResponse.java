 ...
 *         &lt;element name="smsBroadcastLists" type="{http://www.huawei.com/ngin/vpncentrex/domain}SMSBroadcastList" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listSMSBroadcastListResponse")
public class ListSMSBroadcastListResponse {
    ...
    protected List<SMSBroadcastList> smsBroadcastLists;
    ...
    /**
     * Gets the value of the smsBroadcastLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the smsBroadcastLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSmsBroadcastLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SMSBroadcastList }
     * 
     * 
     */
    public List<SMSBroadcastList> getSmsBroadcastLists() {
        if (smsBroadcastLists == null) {
            smsBroadcastLists = new ArrayList<SMSBroadcastList>();
        }
        return this.smsBroadcastLists;
    }
