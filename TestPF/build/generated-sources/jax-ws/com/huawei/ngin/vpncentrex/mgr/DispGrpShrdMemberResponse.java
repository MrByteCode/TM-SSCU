 ...
 *         &lt;element name="GrpShrdMember" type="{http://www.huawei.com/ngin/vpncentrex/domain}GrpShrdMember"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "dispGrpShrdMemberResponse")
public class DispGrpShrdMemberResponse {

    @XmlElement(required = true, nillable = true)
    protected ResponseHeader responseHeader;
    @XmlElement(required = true, nillable = true)
    protected ReturnDes returnDes;
    @XmlElement(name = "GrpShrdMember", required = true, nillable = true)
    protected GrpShrdMember grpShrdMember;
    ...
    /**
     * Obtiene el valor de la propiedad grpShrdMember.
     * 
     * @return
     *     possible object is
     *     {@link GrpShrdMember }
     *     
     */
    public GrpShrdMember getGrpShrdMember() {
        return grpShrdMember;
    }

    /**
     * Define el valor de la propiedad grpShrdMember.
     * 
     * @param value
     *     allowed object is
     *     {@link GrpShrdMember }
     *     
     */
    public void setGrpShrdMember(GrpShrdMember value) {
        this.grpShrdMember = value;
    }
