 ...
 *         &lt;element name="userGroups" type="{http://www.huawei.com/ngin/vpncentrex/domain}UserGroup1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listUserGroupResponse")
public class ListUserGroupResponse {
    ...
    protected List<UserGroup1> userGroups;
     ...
     * 
     */
    public List<UserGroup1> getUserGroups() {
        if (userGroups == null) {
            userGroups = new ArrayList<UserGroup1>();
        }
