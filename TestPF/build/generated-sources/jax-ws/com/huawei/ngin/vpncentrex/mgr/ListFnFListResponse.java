 ...
 *         &lt;element name="fnFLists" type="{http://www.huawei.com/ngin/vpncentrex/domain}FnFList" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listFnFListResponse")
public class ListFnFListResponse {
    ...
    protected List<FnFList> fnFLists;
    ...
    /**
     * Gets the value of the fnFLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fnFLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFnFLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<FnFList> getFnFLists() {
        if (fnFLists == null) {
            fnFLists = new ArrayList<FnFList>();
        }
        return this.fnFLists;
    }
