 ...
 *         &lt;element name="attendantTimes" type="{http://www.huawei.com/ngin/vpncentrex/domain}AttendantTime1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listAttendantWorkTimeResponse")
public class ListAttendantWorkTimeResponse {
    ...
    protected List<AttendantTime1> attendantTimes;
    ...
    /**
     * Gets the value of the attendantTimes property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the attendantTimes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAttendantTimes().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<AttendantTime1> getAttendantTimes() {
        if (attendantTimes == null) {
            attendantTimes = new ArrayList<AttendantTime1>();
        }
        return this.attendantTimes;
    }
