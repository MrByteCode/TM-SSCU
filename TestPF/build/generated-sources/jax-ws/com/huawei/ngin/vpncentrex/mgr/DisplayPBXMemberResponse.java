 ...
 *         &lt;element name="PBXMember" type="{http://www.huawei.com/ngin/vpncentrex/domain}PBXMember2"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "displayPBXMemberResponse")
public class DisplayPBXMemberResponse {

    @XmlElement(required = true, nillable = true)
    protected ResponseHeader responseHeader;
    @XmlElement(required = true, nillable = true)
    protected ReturnDes returnDes;
    @XmlElement(name = "PBXMember", required = true, nillable = true)
    protected PBXMember2 pbxMember;
     ...
     *     
     */
    public PBXMember2 getPBXMember() {
        return pbxMember;
    }
     ...
     *     
     */
    public void setPBXMember(PBXMember2 value) {
