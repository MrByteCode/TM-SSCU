 ...
 *         &lt;element name="enterpriseAdmins" type="{http://www.huawei.com/ngin/vpncentrex/domain}EnterpriseAdmin2" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listEnterpriseAdministratorResponse")
public class ListEnterpriseAdministratorResponse {
    ...
    protected List<EnterpriseAdmin2> enterpriseAdmins;
    ...
    /**
     * Gets the value of the enterpriseAdmins property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the enterpriseAdmins property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEnterpriseAdmins().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link EnterpriseAdmin2 }
     * 
     * 
     */
    public List<EnterpriseAdmin2> getEnterpriseAdmins() {
        if (enterpriseAdmins == null) {
            enterpriseAdmins = new ArrayList<EnterpriseAdmin2>();
        }
