 ...
 *         &lt;element name="members" type="{http://www.huawei.com/ngin/vpncentrex/domain}PBXMember4" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listPBXMemberResponse")
public class ListPBXMemberResponse {
    ...
    protected List<PBXMember4> members;
     ...
     * 
     */
    public List<PBXMember4> getMembers() {
        if (members == null) {
            members = new ArrayList<PBXMember4>();
        }
        return this.members;
    }
