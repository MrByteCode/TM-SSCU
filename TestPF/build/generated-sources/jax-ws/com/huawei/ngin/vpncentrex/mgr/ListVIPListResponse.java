 ...
 *         &lt;element name="vipLists" type="{http://www.huawei.com/ngin/vpncentrex/domain}VIPList" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listVIPListResponse")
public class ListVIPListResponse {
    ...
    protected List<VIPList> vipLists;
    ...
    /**
     * Gets the value of the vipLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the vipLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVipLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<VIPList> getVipLists() {
        if (vipLists == null) {
            vipLists = new ArrayList<VIPList>();
        }
