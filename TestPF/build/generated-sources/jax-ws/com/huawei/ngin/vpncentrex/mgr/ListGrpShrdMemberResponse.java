 ...
 *         &lt;element name="GrpShrdMember" type="{http://www.huawei.com/ngin/vpncentrex/domain}GrpShrdMember" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listGrpShrdMemberResponse")
public class ListGrpShrdMemberResponse {
    ...
    @XmlElement(name = "GrpShrdMember", nillable = true)
    protected List<GrpShrdMember> grpShrdMember;
    ...
    /**
     * Gets the value of the grpShrdMember property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the grpShrdMember property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGrpShrdMember().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<GrpShrdMember> getGrpShrdMember() {
        if (grpShrdMember == null) {
            grpShrdMember = new ArrayList<GrpShrdMember>();
        }
        return this.grpShrdMember;
    }
