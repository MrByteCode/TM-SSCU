 ...
 *         &lt;element name="profiles" type="{http://www.huawei.com/ngin/vpncentrex/domain}Profile1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listProfileResponse")
public class ListProfileResponse {
    ...
    protected List<Profile1> profiles;
     ...
     * 
     */
    public List<Profile1> getProfiles() {
        if (profiles == null) {
            profiles = new ArrayList<Profile1>();
        }
