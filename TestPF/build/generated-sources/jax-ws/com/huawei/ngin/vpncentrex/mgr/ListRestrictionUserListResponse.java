 ...
 *         &lt;element name="restrictionUserLists" type="{http://www.huawei.com/ngin/vpncentrex/domain}RestrictionUserList1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ListRestrictionUserListResponse {
    ...
    protected List<RestrictionUserList1> restrictionUserLists;
     ...
     * {@link RestrictionUserList1 }
     * 
     * 
     */
    public List<RestrictionUserList1> getRestrictionUserLists() {
        if (restrictionUserLists == null) {
            restrictionUserLists = new ArrayList<RestrictionUserList1>();
        }
