 ...
 *         &lt;element name="discountlistInfos" type="{http://www.huawei.com/ngin/vpncentrex/domain}DiscountlistInfo" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listDiscountlistResponse")
public class ListDiscountlistResponse {
    ...
    protected List<DiscountlistInfo> discountlistInfos;
    ...
    /**
     * Gets the value of the discountlistInfos property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the discountlistInfos property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDiscountlistInfos().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DiscountlistInfo }
     * 
     * 
     */
    public List<DiscountlistInfo> getDiscountlistInfos() {
        if (discountlistInfos == null) {
            discountlistInfos = new ArrayList<DiscountlistInfo>();
        }
        return this.discountlistInfos;
    }
