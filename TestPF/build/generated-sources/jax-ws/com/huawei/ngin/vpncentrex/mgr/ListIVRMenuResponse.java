 ...
 *         &lt;element name="entIVRMenus" type="{http://www.huawei.com/ngin/vpncentrex/domain}EntIVRMenu1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listIVRMenuResponse")
public class ListIVRMenuResponse {
    ...
    protected List<EntIVRMenu1> entIVRMenus;
    ...
    /**
     * Gets the value of the entIVRMenus property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the entIVRMenus property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEntIVRMenus().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<EntIVRMenu1> getEntIVRMenus() {
        if (entIVRMenus == null) {
            entIVRMenus = new ArrayList<EntIVRMenu1>();
        }
        return this.entIVRMenus;
    }
