 ...
 *         &lt;element name="callAdmissionControls" type="{http://www.huawei.com/ngin/vpncentrex/domain}CallAdmissionControl" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "", propOrder = {
    ...
    "rowsPerPage",
    "totalPageNum",
    "callAdmissionControls",
    "entTotalMaxConcurrentLimit"
})
@XmlRootElement(name = "listCallAdmissionControlResponse")
public class ListCallAdmissionControlResponse {
    ...
    protected List<CallAdmissionControl> callAdmissionControls;
    @XmlElement(required = true, nillable = true)
    ...
    /**
     * Gets the value of the callAdmissionControls property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the callAdmissionControls property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCallAdmissionControls().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CallAdmissionControl> getCallAdmissionControls() {
        if (callAdmissionControls == null) {
            callAdmissionControls = new ArrayList<CallAdmissionControl>();
        }
        return this.callAdmissionControls;
    }
