 ...
 *         &lt;element name="vipCustomers" type="{http://www.huawei.com/ngin/vpncentrex/domain}VipCustomer2" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listVIPCustomerListResponse")
public class ListVIPCustomerListResponse {
    ...
    protected List<VipCustomer2> vipCustomers;
    ...
    /**
     * Gets the value of the vipCustomers property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the vipCustomers property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVipCustomers().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<VipCustomer2> getVipCustomers() {
        if (vipCustomers == null) {
            vipCustomers = new ArrayList<VipCustomer2>();
        }
