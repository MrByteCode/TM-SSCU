 ...
 *         &lt;element name="interGroups" type="{http://www.huawei.com/ngin/vpncentrex/domain}InterGroup1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listIntergroupResponse")
public class ListIntergroupResponse {
    ...
    protected List<InterGroup1> interGroups;
    ...
    /**
     * Gets the value of the interGroups property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the interGroups property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInterGroups().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<InterGroup1> getInterGroups() {
        if (interGroups == null) {
            interGroups = new ArrayList<InterGroup1>();
        }
