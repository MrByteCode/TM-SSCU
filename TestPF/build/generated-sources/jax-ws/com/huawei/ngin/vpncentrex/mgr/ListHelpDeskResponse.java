 ...
 *         &lt;element name="helpDesks" type="{http://www.huawei.com/ngin/vpncentrex/domain}HelpDesk" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listHelpDeskResponse")
public class ListHelpDeskResponse {
    ...
    protected List<HelpDesk> helpDesks;
    ...
    /**
     * Gets the value of the helpDesks property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the helpDesks property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHelpDesks().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<HelpDesk> getHelpDesks() {
        if (helpDesks == null) {
            helpDesks = new ArrayList<HelpDesk>();
        }
