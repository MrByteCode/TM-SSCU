 ...
 *         &lt;element name="transResult" type="{http://www.huawei.com/ngin/vpncentrex/domain}transResult" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listtransResultResponse")
public class ListtransResultResponse {
    ...
    protected List<TransResult> transResult;
     ...
     * This is why there is not a <CODE>set</CODE> method for the transResult property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTransResult().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<TransResult> getTransResult() {
        if (transResult == null) {
            transResult = new ArrayList<TransResult>();
        }
