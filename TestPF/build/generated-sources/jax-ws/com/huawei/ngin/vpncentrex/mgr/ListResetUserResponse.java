 ...
 *         &lt;element name="resetUserLists" type="{http://www.huawei.com/ngin/vpncentrex/domain}ResetUserList" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listResetUserResponse")
public class ListResetUserResponse {
    ...
    protected List<ResetUserList> resetUserLists;
    ...
    /**
     * Gets the value of the resetUserLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the resetUserLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getResetUserLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ResetUserList> getResetUserLists() {
        if (resetUserLists == null) {
            resetUserLists = new ArrayList<ResetUserList>();
        }
        return this.resetUserLists;
    }
