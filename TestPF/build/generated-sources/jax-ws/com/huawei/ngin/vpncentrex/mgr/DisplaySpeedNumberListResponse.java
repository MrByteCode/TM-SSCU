 ...
 *         &lt;element name="speedNLInfoList" type="{http://www.huawei.com/ngin/vpncentrex/domain}SpeedNLInfoList"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "displaySpeedNumberListResponse")
public class DisplaySpeedNumberListResponse {
    ...
    @XmlElement(required = true, nillable = true)
    protected SpeedNLInfoList speedNLInfoList;
     ...
     *     
     */
    public SpeedNLInfoList getSpeedNLInfoList() {
     ...
     *     
     */
    public void setSpeedNLInfoList(SpeedNLInfoList value) {
