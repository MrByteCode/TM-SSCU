 ...
 *         &lt;element name="huntingGroups" type="{http://www.huawei.com/ngin/vpncentrex/domain}HuntingGroup4" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listHuntingGroupResponse")
public class ListHuntingGroupResponse {
    ...
    protected List<HuntingGroup4> huntingGroups;
     ...
     * 
     */
    public List<HuntingGroup4> getHuntingGroups() {
        if (huntingGroups == null) {
            huntingGroups = new ArrayList<HuntingGroup4>();
        }
