 ...
 *         &lt;element name="officeZones" type="{http://www.huawei.com/ngin/vpncentrex/domain}OfficeZone" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "listOfficeZoneResponse")
public class ListOfficeZoneResponse {
    ...
    protected List<OfficeZone> officeZones;
    ...
    /**
     * Gets the value of the officeZones property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the officeZones property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOfficeZones().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OfficeZone> getOfficeZones() {
        if (officeZones == null) {
            officeZones = new ArrayList<OfficeZone>();
        }
        return this.officeZones;
    }
